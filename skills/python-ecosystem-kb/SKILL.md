...
description: 파이썬 및 Django 생태계의 대표 라이브러리, ORM, 데이터베이스, 웹 프레임워크, 툴체인을 온디맨드로 실시간 탐색 및 추천할 때 사용합니다. (Awesome Python, Awesome Django, WikiDocs 14021 연계)
---

# Python Ecosystem Knowledge Base Skill

본 스킬은 파이썬 및 Django 생태계의 최신 패키지 큐레이션 및 기술 스택을 온디맨드(Read-on-Demand)로 탐색하여 최적의 패키지를 추천하는 가이드입니다.
...
* **사용법**: 에이전트 내장 파일 텍스트 검색 도구(Grep / File Search)를 사용하여 `resources/wikidocs-14021.md` 자원 파일 내의 기술 키워드를 온디맨드로 부분 검색하십시오. 항목별 수록된 위키독스 URL(`https://wikidocs.net/<id>`)로 상세 페이지 접근이 가능합니다.
