...
### 2.2 기계적 검증 최우선 (Harness-First Execution)
...
복잡하거나 파괴적인 작업, 다수의 선택지가 존재하는 작업 수행 시 구현에 앞서 다음 기획 하네스를 먼저 정렬합니다:
...
**Version**: 2.0.0 | **Ratified**: 2026-08-05 | **Architecture**: Modern Planning-First Harness
