...
에이전트가 시스템 상태를 변경할 때 적용하는 기획 중심 execution 프로토콜입니다.

---

## 🎯 1단계: 기획 계약 정렬 (Planning Contract Alignment)
...
## 🛠️ 2단계: 수술적 편집 및 콤팩트 실행 (Surgical Execution)
...
## 🧪 3단계: 정량적 기계 검증 (Mechanical Validation)
...
## 🔍 5단계: 선택적 auditor 서브에이전트 활용 (Optional Audit)
