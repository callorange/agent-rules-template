...
- **Docstring 및 주석 언어**:
  - 명시된 프로젝트 언어를 우선합니다.
  - 프로젝트 언어가 지정되지 않은 경우 사용자가 명시한 언어 또는 사용자의 주 언어를 사용합니다.
  - 사용자 언어가 불명확한 경우 기존 프로젝트 관례를 따릅니다.
  - 기존 Docstring이나 주석을 수정할 때는 기존 언어를 유지하며, 번역 요청이 있는 경우에만 언어를 변경합니다.
  - `Args`, `Returns`, `Raises`와 같은 표준 섹션명 및 기술 고유명사는 영어를 사용할 수 있습니다.
  - LLM 에이전트는 별도 지시 없이 문서화 언어를 임의로 변경하지 않습니다.
- **주석 (Comments)**:
